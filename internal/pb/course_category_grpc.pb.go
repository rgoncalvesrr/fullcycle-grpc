...
type CategoryServiceClient interface {
	...
	CreateCategoryStreamVaiVem(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryStreamVaiVemClient, error)
...
func (c *categoryServiceClient) CreateCategoryStreamVaiVem(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryStreamVaiVemClient, error) {
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], "/pb.CategoryService/CreateCategoryStreamVaiVem", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceCreateCategoryStreamVaiVemClient{stream}
	return x, nil
}

type CategoryService_CreateCategoryStreamVaiVemClient interface {
	Send(*CreateCategoryRequest) error
	Recv() (*Category, error)
	grpc.ClientStream
}

type categoryServiceCreateCategoryStreamVaiVemClient struct {
	grpc.ClientStream
}

func (x *categoryServiceCreateCategoryStreamVaiVemClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryStreamVaiVemClient) Recv() (*Category, error) {
	m := new(Category)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CategoryServiceServer interface {
	...
	CreateCategoryStreamVaiVem(CategoryService_CreateCategoryStreamVaiVemServer) error
...
func (UnimplementedCategoryServiceServer) CreateCategoryStreamVaiVem(CategoryService_CreateCategoryStreamVaiVemServer) error {
	return status.Errorf(codes.Unimplemented, "method CreateCategoryStreamVaiVem not implemented")
}
...
func _CategoryService_CreateCategoryStreamVaiVem_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryStreamVaiVem(&categoryServiceCreateCategoryStreamVaiVemServer{stream})
}

type CategoryService_CreateCategoryStreamVaiVemServer interface {
	Send(*Category) error
	Recv() (*CreateCategoryRequest, error)
	grpc.ServerStream
}

type categoryServiceCreateCategoryStreamVaiVemServer struct {
	grpc.ServerStream
}

func (x *categoryServiceCreateCategoryStreamVaiVemServer) Send(m *Category) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryStreamVaiVemServer) Recv() (*CreateCategoryRequest, error) {
	m := new(CreateCategoryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "CreateCategoryStreamVaiVem",
			Handler:       _CategoryService_CreateCategoryStreamVaiVem_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
